    ...
    return (
        <div className="container">
            ...
            <div className="row p-5 mt-5 text-muted">
                ...
                <div className="col-6 p-3">
                    <p>In addition, we run a number of popular open online educational and community initiatives to empower retail traders and investors.</p><p>
                        <a href="https://www.rainmatter.com/" style={{ textDecoration: "none" }} target="_blank" rel="noopener noreferrer">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p><p>
